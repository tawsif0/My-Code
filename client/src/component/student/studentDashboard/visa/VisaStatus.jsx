    ...
    <div className="w-full ">
      ...
      <div className="mb-6 relative">
        <button
          ...
          className="flex justify-between items-center w-full px-4 py-6 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors"
        >
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  ...
                  <span className="capitalize">
                    {
                      selectedRequest.processingSteps[
                        selectedRequest.currentStep
                      ].status
                    }
                  </span>
