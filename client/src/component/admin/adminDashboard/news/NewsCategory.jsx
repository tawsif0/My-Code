...
function NewsCategory() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      window.dispatchEvent(new CustomEvent('newsCategoryUpdated', {
        detail: { category: response.data.category }
      }));
      ...
      <div className="w-full max-w-full">
        <div className="w-full mb-8 pb-6 border-b border-gray-200">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900">
            News Category Creation
          </h1>
          <p className="text-gray-600 mt-2">
            Create categories for organizing news articles
          </p>
        </div>
        <motion.div
