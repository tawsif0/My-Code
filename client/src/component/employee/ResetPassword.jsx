...
const ResetPasswordEmployee = () => {
  ...
  // Destructure all required fields from location.state
  const { email, otp, tempToken } = location.state || {};
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${base_url}/api/employee/reset-password`,
        {
          email,
          otp, // Make sure this is the string OTP from location.state
          newPassword,
          tempToken, // Include the tempToken
        }
      );
